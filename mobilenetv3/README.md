...
This folder contains the MobileNetV3 model training scripts for apple disease classification.
...
- **Base**: MobileNetV3Large (ImageNet pre-trained)
...
- **checkpoints/**: Saved model files (.keras)
  - `best_mobilenetv3_optimized_phase1.keras`
  - `best_mobilenetv3_optimized_phase2.keras`
  - `best_mobilenetv3_optimized.keras` (final)
...
- More efficient architecture with better accuracy
