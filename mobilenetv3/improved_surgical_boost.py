...
MODEL_SAVE_PATH = "improved_mobilenetv3_model.keras"
BEST_MODEL_PATH = "best_improved_mobilenetv3_model.keras"
...
def create_model(num_classes):
    """Create optimized MobileNetV3 model"""
...
# ✅ FIXED: Proper layer unfreezing for MobileNetV3
# MobileNetV3 has different structure, adjust accordingly
